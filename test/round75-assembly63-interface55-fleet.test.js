...
const ASSEMBLY_BASE = "ac4a7d4234a8b92eb06fd10d4ceb15dd393daefa";
const ASSEMBLY_HEAD = "de9e0a9b877ba0ed673b131825cf0da2fbb408d7";
const PREVIOUS_INTERFACE = "8c0559abfd705cd7437b94f5840902933eb3ec47";
const EXPECTED = Object.freeze({
  ...
  interface: "e89b091d490ea8cf7dad39cd5106e60da2cce4d8",
...
test("round75 exact Assembly63 receipt advances only the independently integrated Interface55 identity", { timeout: 90000 }, () => {
  const tmp = fs.mkdtempSync(path.join(os.tmpdir(), "axm-round75-"));
  try {
    ...
    assert.ok(parentLines.includes(`parent ${PREVIOUS_INTERFACE}`), "Interface #55 merge commit does not name prior Interface main as parent");
