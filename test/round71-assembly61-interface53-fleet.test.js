...
const ASSEMBLY_BASE = "726fb4ad8efc4068bcda0c2c3d5e3873335b280e";
const ASSEMBLY_HEAD = "af17bacc8b97531b5cbefcf9045e829002d7ae6b";
const PREVIOUS_INTERFACE = "4c14818289bd2d37deaf82c732836d4d2874f3e3";
const EXPECTED = Object.freeze({
  ...
  interface: "cec03d917227881100d4ce576ed49174e51d8210",
...
test("round71 exact Assembly61 receipt advances only the independently integrated Interface53 identity", { timeout: 90000 }, () => {
  const tmp = fs.mkdtempSync(path.join(os.tmpdir(), "axm-round71-"));
  try {
    ...
    assert.equal(before.interface, PREVIOUS_INTERFACE, "predecessor receipt does not pin Interface #52 main");
    assert.equal(after.interface, EXPECTED.interface, "receipt does not pin integrated Interface #53 main");
    ...
    assert.ok(
      ...
      "integrated Interface #53 merge commit does not name prior Interface main as a direct parent"
    );
