...
const ASSEMBLY_BASE = "d77f62e14ac72fb3b47ac9141ad5175e89eb2d5f";
const ASSEMBLY_HEAD = "75bdd1e57dac6fb589069524d67e51c7a513ecad";
const PREVIOUS_INTERFACE = "6a496ece147f13e420385d455ef5a9cfaf899c89";
const EXPECTED = Object.freeze({
  ...
  interface: "4c14818289bd2d37deaf82c732836d4d2874f3e3",
...
test("round69 exact Assembly60 receipt advances only the independently integrated Interface52 identity", { timeout: 90000 }, () => {
  const tmp = fs.mkdtempSync(path.join(os.tmpdir(), "axm-round69-"));
  try {
    ...
    assert.equal(before.interface, PREVIOUS_INTERFACE, "predecessor receipt does not pin Interface #51 main");
    assert.equal(after.interface, EXPECTED.interface, "receipt does not pin integrated Interface #52 main");
    ...
    assert.ok(
      ...
      "integrated Interface #52 merge commit does not name prior Interface main as a direct parent"
    );
